...
@section('title', 'Qualifications — TiX')
...
@if($qualifications->isEmpty())
    <div class="bg-white rounded-xl border border-gray-200 p-12 text-center">
        ...
        <a href="{{ route('qualifications.create') }}" class="inline-flex items-center gap-2 px-4 py-2 bg-[#1e3a5f] text-white text-sm font-medium rounded-lg hover:bg-[#e3b64d] hover:text-[#1e3a5f]">
