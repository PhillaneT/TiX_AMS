        ...
        <form method="POST" action="<?php echo e(route('login')); ?>" class="space-y-4">
            ...
            <div>
                ...
                <input type="email" id="email" name="email" value="<?php echo e(old('email')); ?>" required autofocus
                    class="w-full rounded-lg border border-gray-300 px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent <?php $__errorArgs = ['email'];
...
<?php /**PATH /home/runner/workspace/ams/resources/views/auth/login.blade.php ENDPATH**/ ?>