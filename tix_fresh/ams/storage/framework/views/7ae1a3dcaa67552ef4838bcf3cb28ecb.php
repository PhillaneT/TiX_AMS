<?php $__env->startSection('title', 'Dashboard — TiXMark IQ'); ?>
...
<div class="bg-white rounded-xl border border-gray-200 p-5 mb-6 mt-2">
    ...
    <form method="POST" action="<?php echo e(route('context.update')); ?>" class="flex flex-wrap gap-4 items-end">
        <?php echo csrf_field(); ?>
        <div class="flex-1 min-w-48">
            ...
            <select name="qualification_id" id="ctx-qual"
                ...
                <?php $__currentLoopData = $qualifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $q): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($q->id); ?>"
                        <?php echo e($context?->qualification_id == $q->id ? 'selected' : ''); ?>>
                        <?php echo e($q->name); ?> (NQF <?php echo e($q->nqf_level); ?>)
                    </option>
        ...
        <div class="flex-1 min-w-48">
            ...
            <select name="cohort_id"
                ...
                <?php $__currentLoopData = $cohorts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($c->id); ?>"
                        <?php echo e($context?->cohort_id == $c->id ? 'selected' : ''); ?>>
                        <?php echo e($c->name); ?> <?php echo e($c->year ? "({$c->year})" : ''); ?>
    ...
    <?php if(!$qualifications->count()): ?>
        <div class="mt-4 p-4 bg-amber-50 border border-amber-200 rounded-lg text-sm text-amber-800">
            ...
            <a href="<?php echo e(route('qualifications.create')); ?>" class="ml-2 underline font-medium">Create your first qualification →</a>
        </div>
    <?php endif; ?>
</div>

<?php if($context?->cohort_id): ?>
<?php
...
<div class="grid grid-cols-2 lg:grid-cols-5 gap-4 mb-6">
    ...
    <a href="<?php echo e(route('qualifications.cohorts.learners.index', [$qual, $cohrt])); ?>"
       class="bg-white rounded-xl border border-gray-200 p-4 hover:border-orange-300 hover:shadow-sm transition group block">
        ...
        <p class="text-2xl font-bold text-gray-900 mt-1"><?php echo e($stats['learners'] ?? 0); ?></p>
        <p class="text-xs text-gray-400 mt-0.5 group-hover:text-orange-500 transition">View all →</p>
    </a>

    
    <a href="<?php echo e(route('qualifications.cohorts.show', [$qual, $cohrt])); ?>"
       class="bg-white rounded-xl border border-gray-200 p-4 hover:border-orange-300 hover:shadow-sm transition group block">
        <p class="text-xs text-gray-500 font-medium group-hover:text-orange-600 transition">Submissions</p>
        <p class="text-2xl font-bold text-gray-900 mt-1"><?php echo e($stats['submissions'] ?? 0); ?></p>
    ...
    <a href="<?php echo e(route('qualifications.cohorts.learners.index', [$qual, $cohrt])); ?>"
       class="bg-white rounded-xl border border-gray-200 p-4 hover:border-orange-300 hover:shadow-sm transition group block">
        ...
        <p class="text-2xl font-bold text-orange-600 mt-1"><?php echo e($stats['pending_review'] ?? 0); ?></p>
    ...
    <a href="<?php echo e(route('qualifications.cohorts.learners.index', [$qual, $cohrt])); ?>"
       class="bg-white rounded-xl border border-gray-200 p-4 hover:border-green-300 hover:shadow-sm transition group block">
        ...
        <p class="text-2xl font-bold text-green-600 mt-1"><?php echo e($stats['signed_off'] ?? 0); ?></p>
    ...
    <a href="<?php echo e(route('qualifications.cohorts.learners.index', [$qual, $cohrt])); ?>"
       class="bg-white rounded-xl border border-gray-200 p-4 hover:border-purple-300 hover:shadow-sm transition group block">
        ...
        <p class="text-2xl font-bold text-purple-600 mt-1"><?php echo e($stats['emailed'] ?? 0); ?></p>
...
<div class="bg-white rounded-xl border border-gray-200">
    ...
    <div class="divide-y divide-gray-100">
        <?php $__currentLoopData = $recent; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php
        ...
        <div class="px-5 py-3 flex items-center justify-between hover:bg-gray-50 transition">
            <div class="flex-1 min-w-0">
                <a href="<?php echo e($poeLink); ?>"
                   class="text-sm font-medium text-gray-900 hover:text-orange-600 transition">
                    <?php echo e($learner->full_name); ?>

                </a>
                <p class="text-xs text-gray-500 truncate"><?php echo e($sub->assignment->name); ?></p>
            </div>
            <a href="<?php echo e($subLink); ?>"
               class="ml-3 inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium <?php echo e($badge['class']); ?> hover:opacity-80 transition shrink-0">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/runner/workspace/ams/resources/views/dashboard.blade.php ENDPATH**/ ?>