<?php $__env->startSection('title', 'New Qualification — TiXMark IQ'); ?>
<?php $__env->startSection('heading', 'New Qualification'); ?>
...
<div class="max-w-2xl mt-2 space-y-4">
    ...
    <div class="bg-white rounded-xl border border-gray-200 p-6">
        <form method="POST" action="<?php echo e(route('qualifications.store')); ?>" class="space-y-5">
            <?php echo csrf_field(); ?>
            ...
            <div class="grid grid-cols-2 gap-4">
                <div class="col-span-2">
                    ...
                    <input type="text" name="name" id="field_name" value="<?php echo e(old('name')); ?>" required
                ...
                <div>
                    ...
                    <input type="text" name="saqa_id" id="field_saqa_id" value="<?php echo e(old('saqa_id')); ?>"
                        class="w-full rounded-lg border border-gray-300 px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-orange-500"
                ...
                <div>
                    ...
                    <select name="nqf_level" id="field_nqf_level" required
                        class="w-full rounded-lg border border-gray-300 px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-orange-500">
                        <?php for($i = 1; $i <= 10; $i++): ?>
                            <option value="<?php echo e($i); ?>" <?php echo e(old('nqf_level', 4) == $i ? 'selected' : ''); ?>>Level <?php echo e($i); ?></option>
                        <?php endfor; ?>
                    </select>
                </div>
                ...
                <div>
                    ...
                    <select name="track" id="field_track" required
                        class="w-full rounded-lg border border-gray-300 px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-orange-500">
                        <option value="qcto_occupational" <?php echo e(old('track', 'qcto_occupational') === 'qcto_occupational' ? 'selected' : ''); ?>>QCTO Occupational</option>
                        <option value="legacy_seta" <?php echo e(old('track') === 'legacy_seta' ? 'selected' : ''); ?>>Legacy SETA</option>
                    </select>
                ...
                <div>
                    ...
                    <input type="number" name="credits" id="field_credits" value="<?php echo e(old('credits')); ?>" min="1"
                        class="w-full rounded-lg border border-gray-300 px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-orange-500"
                        placeholder="e.g. 120">
                </div>
                ...
                <div>
                    ...
                    <select name="seta" id="field_seta" required
                        ...
                        <?php $__currentLoopData = ['MICT', 'ETDP', 'SERVICES', 'BANKSETA', 'CATHSSETA', 'CETA', 'CHIETA', 'EWSETA', 'FASSET', 'FIETA', 'FoodBev', 'HWSETA', 'INSETA', 'LGSETA', 'MAPPP', 'MQA', 'MERSETA', 'POSHEITA', 'PSETA', 'RCL', 'SASSETA', 'TETA', 'W&RSETA']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($s); ?>" <?php echo e(old('seta', 'MICT') === $s ? 'selected' : ''); ?>><?php echo e($s); ?></option>
                ...
                <div class="col-span-2">
                    ...
                    <input type="text" name="seta_registration_number" value="<?php echo e(old('seta_registration_number')); ?>"
                        class="w-full rounded-lg border border-gray-300 px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-orange-500"
                ...
                <div class="col-span-2">
                    ...
                    <textarea name="notes" rows="3"
                        class="w-full rounded-lg border border-gray-300 px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-orange-500"
                        placeholder="Any internal notes about this qualification..."><?php echo e(old('notes')); ?></textarea>
                </div>
            </div>
            ...
            <div class="flex items-center gap-3 pt-2 border-t border-gray-100">
                ...
                <a href="<?php echo e(route('qualifications.index')); ?>" class="px-5 py-2.5 text-sm text-gray-600 hover:text-gray-900">Cancel</a>
            </div>
        </form>
    </div>
</div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/runner/workspace/ams/resources/views/qualifications/create.blade.php ENDPATH**/ ?>