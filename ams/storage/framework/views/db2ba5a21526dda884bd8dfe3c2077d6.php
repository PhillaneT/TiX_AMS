<?php $__env->startSection('title', 'Marking Result — ' . $submission->assignment->name); ?>
<?php $__env->startSection('heading', $submission->assignment->name); ?>
<?php $__env->startSection('breadcrumbs'); ?>
    ...
    <span class="text-gray-300 mx-0.5">›</span>
    <a href="<?php echo e(route('qualifications.cohorts.learners.poe', [$qualification, $cohort, $learner])); ?>" class="hover:text-gray-800 transition-colors"><?php echo e($learner->full_name); ?></a>
    <span class="text-gray-300 mx-0.5">›</span>
    <span class="text-gray-700 font-medium"><?php echo e($submission->assignment->name); ?></span>
...
<div class="bg-white rounded-xl border border-gray-200 shadow-sm p-5 mb-6">
    <div class="flex items-start justify-between gap-4 flex-wrap">
        <div>
            <h1 class="text-xl font-bold text-gray-900"><?php echo e($submission->assignment->name); ?></h1>
            <div class="mt-1 text-sm text-gray-500 flex flex-wrap gap-3">
                <span>Learner: <strong class="text-gray-700"><?php echo e($learner->full_name); ?></strong></span>
                <span>&bull; File: <strong class="text-gray-700"><?php echo e($submission->original_filename); ?></strong></span>
                <span>&bull; Uploaded: <?php echo e($submission->created_at->format('d M Y H:i')); ?></span>
            </div>
        </div>

        <?php if($result): ?>
        <?php $rec = $result->ai_recommendation; $isC = $rec === 'COMPETENT'; ?>
        <div class="text-center px-5 py-3 rounded-xl border-2 <?php echo e($isC ? 'bg-green-50 border-green-300' : 'bg-red-50 border-red-300'); ?>">
            <div class="text-xs font-semibold <?php echo e($isC ? 'text-green-600' : 'text-red-600'); ?> mb-0.5">AI Recommendation</div>
            <div class="text-lg font-black <?php echo e($isC ? 'text-green-700' : 'text-red-700'); ?>">
                <?php echo e($isC ? 'COMPETENT' : 'NOT YET COMPETENT'); ?>

            </div>
            <div class="text-xs <?php echo e($isC ? 'text-green-500' : 'text-red-500'); ?> mt-0.5">
                Confidence: <?php echo e($result->confidence); ?>

                <?php if($result->mock_mode): ?> &bull; <span class="font-semibold">MOCK</span> <?php endif; ?>
            </div>
        </div>
        <?php endif; ?>
    </div>
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
    ...
    <div class="lg:col-span-2 space-y-6">
        ...
        <?php if($result && ! empty($result->questions_json)): ?>
        <?php
        ...
        <div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden" id="criteria-panel">
            <div class="px-5 py-3 bg-gray-50 border-b border-gray-200 flex items-center justify-between">
                ...
                <span id="total-display" class="text-sm font-bold <?php echo e($pct >= 50 ? 'text-green-700' : 'text-red-700'); ?>">
                    <?php echo e($totalAwarded); ?> / <?php echo e($totalMax); ?> (<?php echo e($pct); ?>%)
                </span>
            </div>
            ...
            <div class="px-5 pt-3 pb-1">
                <div class="w-full bg-gray-100 rounded-full h-2.5">
                    <div id="score-bar" class="h-2.5 rounded-full transition-all <?php echo e($pct >= 50 ? 'bg-green-500' : 'bg-red-500'); ?>"
                         style="width: <?php echo e(min(100, $pct)); ?>%"></div>
                </div>
                <div class="flex justify-between text-xs text-gray-400 mt-1">
                    <span>0</span>
                    <span class="text-gray-500 font-medium">Pass mark: 50%</span>
                    <span><?php echo e($totalMax); ?></span>
                </div>
            </div>
            ...
            <table class="w-full text-sm" id="criteria-table">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    ?>
                    <tr class="hover:bg-gray-50" data-row="<?php echo e($i); ?>">
                        <td class="px-3 py-2 text-gray-400 text-xs">
                            <span class="inline-flex items-center justify-center w-5 h-5 rounded-full text-xs font-bold <?php echo e($stampBg); ?>" id="row-stamp-<?php echo e($i); ?>">
                                <?php echo e($stamp); ?>

                            </span>
                        </td>
                        <td class="px-3 py-2 text-gray-800 text-xs leading-snug"><?php echo e($q['criterion'] ?? $q['question'] ?? '—'); ?></td>
                        <td class="px-3 py-2 text-center">
                            <div class="flex items-center justify-center gap-1">
                                <input type="number"
                                       id="awarded-<?php echo e($i); ?>"
                                       data-idx="<?php echo e($i); ?>"
                                       data-max="<?php echo e($q['max_marks']); ?>"
                                       value="<?php echo e($q['awarded']); ?>"
                                       min="0" max="<?php echo e($q['max_marks']); ?>"
                                       class="criteria-mark w-14 text-center text-xs font-semibold border border-gray-200 rounded px-1 py-0.5 focus:outline-none focus:ring-2 focus:ring-orange-300 <?php echo e($rowCls); ?>">
                                <span class="text-xs text-gray-400">/ <?php echo e($q['max_marks']); ?></span>
                            </div>
                        </td>
                        <td class="px-3 py-2">
                            <input type="text"
                                   id="comment-<?php echo e($i); ?>"
                                   data-idx="<?php echo e($i); ?>"
                                   value="<?php echo e($q['comment'] ?? ''); ?>"
                                   maxlength="500"
                ...
                <tfoot>
                    <tr class="border-t-2 border-gray-200 bg-gray-50">
                        ...
                        <td class="px-3 py-2 text-center text-sm font-black" id="total-cell">
                            <span class="<?php echo e($pct >= 50 ? 'text-green-700' : 'text-red-700'); ?>"><?php echo e($totalAwarded); ?> / <?php echo e($totalMax); ?></span>
                        </td>
                        <td class="px-3 py-2 text-xs text-gray-400" id="pct-cell"><?php echo e($pct); ?>%</td>
                    </tr>
                </tfoot>
            </table>
    ...
    <div class="space-y-4">
        ...
        <div class="bg-blue-50 border border-blue-200 rounded-xl p-4">
            ...
            <?php if($mappedModules->isNotEmpty()): ?>
            <div class="mb-2">
                <span class="text-xs text-blue-600 font-semibold">Module Scope: </span>
                <?php $__currentLoopData = $mappedModules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <span class="inline-flex items-center px-1.5 py-0.5 rounded text-xs font-bold mr-1
                        <?php echo e(['KM'=>'bg-blue-100 text-blue-800','PM'=>'bg-green-100 text-green-800','WM'=>'bg-orange-100 text-orange-800','US'=>'bg-purple-100 text-purple-800'][strtoupper($m->module_type)] ?? 'bg-gray-100 text-gray-700'); ?>">
                        <?php echo e(strtoupper($m->module_type)); ?>

                    </span>
                    <span class="text-xs text-blue-700"><?php echo e($m->title); ?></span>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
            <?php endif; ?>
            <p class="text-xs text-blue-700 leading-relaxed"><?php echo e($effectiveInstructions); ?></p>
            <?php if(! trim($submission->assignment->ai_instructions ?? '')): ?>
        ...
        <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-4">
            ...
            <?php $badge = $submission->statusBadge(); ?>
            <span class="inline-flex px-3 py-1 rounded-full text-xs font-semibold <?php echo e($badge['class']); ?>">
                <?php echo e($badge['label']); ?>

            </span>
            <?php if($submission->marked_at): ?>
                <p class="mt-2 text-xs text-gray-400">Marked: <?php echo e($submission->marked_at->format('d M Y H:i')); ?></p>
            <?php endif; ?>
            <?php if($submission->signed_off_at): ?>
                <p class="text-xs text-gray-400">Signed off: <?php echo e($submission->signed_off_at->format('d M Y H:i')); ?></p>
            <?php endif; ?>
            <?php if($result?->mock_mode): ?>
            ...
            <?php endif; ?>
            <?php if($result?->annotated_pdf_path): ?>
                <p class="mt-2 text-xs text-green-600 font-semibold">✓ Annotated PDF generated</p>
            <?php endif; ?>
        </div>

        <?php if($submission->status === 'review_required' && $result): ?>
        <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-4">
            ...
            <form method="POST"
                  action="<?php echo e(route('qualifications.cohorts.learners.submissions.signoff', [$qualification, $cohort, $learner, $submission])); ?>">
                <?php echo csrf_field(); ?>
                ...
                <fieldset class="mb-4">
                    ...
                    <label class="flex items-center gap-2 mb-2 cursor-pointer">
                        <input type="radio" name="final_verdict" value="COMPETENT"
                               <?php echo e($result->ai_recommendation === 'COMPETENT' ? 'checked' : ''); ?>
                    ...
                    <label class="flex items-center gap-2 cursor-pointer">
                        <input type="radio" name="final_verdict" value="NOT_YET_COMPETENT"
                               <?php echo e($result->ai_recommendation === 'NOT_YET_COMPETENT' ? 'checked' : ''); ?>
                ...
                <div class="mb-4">
                    ...
                    <textarea name="moderation_notes" rows="3"
                              ...
                              placeholder="Override reasons, observations, etc."><?php echo e(old('moderation_notes')); ?></textarea>
                </div>

                <div class="mb-4 text-xs text-gray-500">
                    Signing off as: <strong class="text-gray-700"><?php echo e(auth()->user()->name); ?></strong>
                </div>
        ...
        <?php if($submission->status === 'signed_off' && $result): ?>
        <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-4">
            <h3 class="text-sm font-semibold text-gray-800 mb-3">Final Verdict</h3>
            <?php $fc = $result->final_verdict === 'COMPETENT'; ?>
            <div class="text-center py-3">
                <div class="text-2xl font-black <?php echo e($fc ? 'text-green-700' : 'text-red-700'); ?>">
                    <?php echo e($fc ? '✓ COMPETENT' : '✗ NOT YET COMPETENT'); ?>

                </div>
                <div class="text-xs text-gray-500 mt-1">
                    Signed off by <?php echo e($result->assessor_name); ?>

                    <?php if($result->signed_off_at): ?> on <?php echo e($result->signed_off_at->format('d M Y')); ?><?php endif; ?>
                </div>
                <?php if($result->assessor_override): ?>
            ...
            <form method="POST" class="mt-3"
                  action="<?php echo e(route('qualifications.cohorts.learners.submissions.reopen', [$qualification, $cohort, $learner, $submission])); ?>"
        ...
        <?php if($submission->isFromMoodle()): ?>
        <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-4">
            ...
            <?php if($submission->lms_pushed_at): ?>
            <div class="mb-3 px-3 py-2 rounded-lg bg-green-50 border border-green-200 text-xs text-green-700">
                Pushed to Moodle on <?php echo e($submission->lms_pushed_at->format('d M Y H:i')); ?>

            </div>
            <?php endif; ?>
            <?php if($submission->status === 'signed_off'): ?>
            <form method="POST" action="<?php echo e(route('integrations.push', [$submission->lms_connection_id, $submission])); ?>">
                <?php echo csrf_field(); ?>
                <button type="submit"
        ...
        <a href="<?php echo e(route('qualifications.cohorts.learners.poe', [$qualification, $cohort, $learner])); ?>"
...
<script>
// ─── Data from server ────────────────────────────────────────────────────────
const PDF_URL         = <?php echo json_encode($fileUrl, 15, 512) ?>;
const SAVE_URL        = <?php echo json_encode($saveAnnUrl, 15, 512) ?>;
const CSRF_TOKEN      = document.querySelector('meta[name="csrf-token"]')?.content ?? '';
const TOTAL_MAX_MARKS = <?php echo e(collect($result->questions_json ?? [])->sum('max_marks')); ?>;

let annotations = <?php echo json_encode($initialAnnotations, 15, 512) ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/runner/workspace/ams/resources/views/submissions/show.blade.php ENDPATH**/ ?>