<?php $__env->startSection('title', 'New Assignment — ' . $qualification->name); ?>
<?php $__env->startSection('heading', 'New Assignment'); ?>
...
<div class="max-w-2xl mt-2">
    <div class="bg-white rounded-xl border border-gray-200 p-6">
        <form method="POST"
              action="<?php echo e(route('qualifications.assignments.store', $qualification)); ?>"
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div class="col-span-2">
                    ...
                    <textarea name="description" rows="2"
                        class="w-full rounded-lg border border-gray-300 px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-orange-500"
                        placeholder="Brief description of what this assignment covers..."><?php echo e(old('description')); ?></textarea>
                </div>
                ...
                <div>
                    ...
                    <select name="type" required
                        class="w-full rounded-lg border border-gray-300 px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-orange-500">
                        <option value="formative" <?php echo e(old('type', 'formative') === 'formative' ? 'selected' : ''); ?>>Formative</option>
                        <option value="summative" <?php echo e(old('type') === 'summative' ? 'selected' : ''); ?>>Summative</option>
                    </select>
                ...
                <div>
                    ...
                    <input type="number" name="total_marks" value="<?php echo e(old('total_marks')); ?>" min="1"
                        class="w-full rounded-lg border border-gray-300 px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-orange-500"
                        placeholder="e.g. 100">
                </div>
                ...
                <div class="col-span-2 pt-2 border-t border-gray-100">
                    ...
                    <div class="flex flex-col gap-2 mb-4">
                        <label class="flex items-start gap-3 cursor-pointer rounded-lg border border-gray-200 px-4 py-3 hover:bg-gray-50 transition-colors has-[:checked]:border-orange-400 has-[:checked]:bg-orange-50">
                            <input type="radio" name="memo_type" value="questions" id="mt_questions"
                                <?php echo e(old('memo_type', 'questions') === 'questions' ? 'checked' : ''); ?>
                        ...
                        <label class="flex items-start gap-3 cursor-pointer rounded-lg border border-gray-200 px-4 py-3 hover:bg-gray-50 transition-colors has-[:checked]:border-orange-400 has-[:checked]:bg-orange-50">
                            <input type="radio" name="memo_type" value="text" id="mt_text"
                                <?php echo e(old('memo_type') === 'text' ? 'checked' : ''); ?>
                        ...
                        <label class="flex items-start gap-3 cursor-pointer rounded-lg border border-gray-200 px-4 py-3 hover:bg-gray-50 transition-colors has-[:checked]:border-orange-400 has-[:checked]:bg-orange-50">
                            <input type="radio" name="memo_type" value="pdf" id="mt_pdf"
                                <?php echo e(old('memo_type') === 'pdf' ? 'checked' : ''); ?>
                    ...
                    <div id="memo_text_area" class="hidden">
                        <textarea name="memo_text" rows="6"
                            ...
                            placeholder="Paste the marking memo / model answers here. The AI marker will use this to evaluate learner submissions."><?php echo e(old('memo_text')); ?></textarea>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/runner/workspace/ams/resources/views/assignments/create.blade.php ENDPATH**/ ?>