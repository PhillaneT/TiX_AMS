<?php $__env->startSection('title', 'Edit — ' . $assignment->name); ?>
<?php $__env->startSection('heading', 'Edit Assignment'); ?>
...
<div class="max-w-2xl mt-2">
    <div class="bg-white rounded-xl border border-gray-200 p-6">
        <form method="POST"
              action="<?php echo e(route('qualifications.assignments.update', [$qualification, $assignment])); ?>"
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div class="col-span-2">
                    ...
                    <input type="text" name="name" value="<?php echo e(old('name', $assignment->name)); ?>" required
                ...
                <div class="col-span-2">
                    ...
                    <textarea name="description" rows="2"
                        class="w-full rounded-lg border border-gray-300 px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-orange-500"><?php echo e(old('description', $assignment->description)); ?></textarea>
                </div>
                ...
                <div>
                    ...
                    <select name="type" required
                        class="w-full rounded-lg border border-gray-300 px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-orange-500">
                        <option value="formative" <?php echo e(old('type', $assignment->type) === 'formative' ? 'selected' : ''); ?>>Formative</option>
                        <option value="summative" <?php echo e(old('type', $assignment->type) === 'summative' ? 'selected' : ''); ?>>Summative</option>
                    </select>
                </div>

                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1.5">Total marks</label>
                    <input type="number" name="total_marks" value="<?php echo e(old('total_marks', $assignment->total_marks)); ?>" min="1"
                        class="w-full rounded-lg border border-gray-300 px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-orange-500">
                </div>
                ...
                <div class="col-span-2 pt-2 border-t border-gray-100">
                    ...
                    <div class="flex flex-col gap-2 mb-4">
                        <label class="flex items-start gap-3 cursor-pointer rounded-lg border border-gray-200 px-4 py-3 hover:bg-gray-50 transition-colors has-[:checked]:border-orange-400 has-[:checked]:bg-orange-50">
                            <input type="radio" name="memo_type" value="questions" id="mt_questions"
                                <?php echo e(old('memo_type', $assignment->memo_type) === 'questions' ? 'checked' : ''); ?>
                        ...
                        <label class="flex items-start gap-3 cursor-pointer rounded-lg border border-gray-200 px-4 py-3 hover:bg-gray-50 transition-colors has-[:checked]:border-orange-400 has-[:checked]:bg-orange-50">
                            <input type="radio" name="memo_type" value="text" id="mt_text"
                                <?php echo e(old('memo_type', $assignment->memo_type) === 'text' ? 'checked' : ''); ?>
                        ...
                        <label class="flex items-start gap-3 cursor-pointer rounded-lg border border-gray-200 px-4 py-3 hover:bg-gray-50 transition-colors has-[:checked]:border-orange-400 has-[:checked]:bg-orange-50">
                            <input type="radio" name="memo_type" value="pdf" id="mt_pdf"
                                <?php echo e(old('memo_type', $assignment->memo_type) === 'pdf' ? 'checked' : ''); ?>
                    ...
                    <div id="memo_questions_area">
                        <?php $qCount = $assignment->questions()->count(); ?>
                        <?php if($qCount > 0): ?>
                            <div class="bg-green-50 border border-green-200 rounded-lg px-4 py-3 text-sm text-green-800 flex items-center gap-3">
                                ...
                                <span><?php echo e($qCount); ?> question<?php echo e($qCount === 1 ? '' : 's'); ?> defined. <a href="<?php echo e(route('qualifications.assignments.show', [$qualification, $assignment])); ?>#questions" class="underline font-medium">View &amp; manage questions</a>.</span>
                            </div>
                        <?php else: ?>
                            <div class="bg-orange-50 border border-orange-200 rounded-lg px-4 py-3 text-sm text-orange-800">
                                ...
                                <p class="text-xs text-orange-700">Save this assignment, then <a href="<?php echo e(route('qualifications.assignments.show', [$qualification, $assignment])); ?>" class="underline font-medium">go to the assignment page</a> to add questions.</p>
                            </div>
                        <?php endif; ?>
                    </div>
                    ...
                    <div id="memo_text_area" class="hidden">
                        <textarea name="memo_text" rows="6"
                            ...
                            placeholder="Paste the marking memo / model answers here..."><?php echo e(old('memo_text', $assignment->memo_text)); ?></textarea>
                    </div>

                    <div id="memo_file_area" class="hidden">
                        <?php if($assignment->memo_path): ?>
                        ...
                        <div class="border-2 border-dashed border-gray-300 rounded-lg px-6 py-6 text-center hover:border-orange-400 transition-colors">
                            <label class="cursor-pointer">
                                <span class="text-sm font-medium text-orange-600"><?php echo e($assignment->memo_path ? 'Upload replacement PDF' : 'Click to upload PDF memo'); ?></span>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/runner/workspace/ams/resources/views/assignments/edit.blade.php ENDPATH**/ ?>